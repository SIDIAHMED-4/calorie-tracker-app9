...
const FOOD_OPTIONS = [
  "Bread","Egg","Rice","Pasta","Beans","Cheese","Milk","Butter","Oil",
  "Chicken","Beef","Fish","Shrimp","Pepper","Onions","Tomato","Apple",
  "Banana","Mango","Watermelon","Strawberry","Dates","Peanuts","Chips",
  "Biscuits","Chocolate","Pizza","Burger","Cake"
];
    ...
    MEAL_OPTIONS.forEach((mealOption) => {
      for (let r = 0; r < RECORDS_PER_MEAL; r++) {
        result.push({
          date: dateStr,
          meal: mealOption,
          content: FOOD_OPTIONS[Math.floor(Math.random() * FOOD_OPTIONS.length)],
          calories: Math.floor(
